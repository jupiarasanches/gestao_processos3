...
export default function DaapPage() {
  ...
  // Obter todos os processos DAAP do contexto
  const daapProcesses = getProcessesByType("DAAP")
  
  // Obter processo selecionado para detalhes
  const selectedProcessData = selectedProcess ? daapProcesses.find(p => p.id === selectedProcess) : null
  
  // Obter processo para upload
  const uploadProcess = uploadProcessId ? daapProcesses.find(p => p.id === uploadProcessId) : null
  
  // Obter processo para documentos
  const documentsProcess = documentsProcessId ? daapProcesses.find(p => p.id === documentsProcessId) : null
  ...
  const handleUpload = async () => {
    ...
    const currentProcess = daapProcesses.find(p => p.id === uploadProcessId)
    if (currentProcess) {
  ...
  const generateDocumentsList = (processId: string, documentsCount: number) => {
    const docTypes = ['Declaração de Atividades', 'Relatório Ambiental', 'Inventário de Emissões', 'Plano de Monitoramento', 'Licença de Operação', 'Estudo de Impacto', 'Comprovante de Regularidade']
    const documents = []
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-foreground">DAAP</h1>
                <p className="text-muted-foreground">Declaração de Atividades Ambientais</p>
              </div>
            </div>
          </div>
          <NewProcessDialog 
            defaultType="DAAP"
            buttonText="Novo DAAP"
          />
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="border-gray-200 bg-gray-50 dark:bg-gray-950/20">
            <CardHeader className="pb-3">
              <CardTitle className="text-gray-700 dark:text-gray-300 text-lg">Total de Processos</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-gray-800 dark:text-gray-200">{daapProcesses.length}</div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Processos DAAP ativos</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-green-200 bg-green-50 dark:bg-green-950/20">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-green-800 dark:text-green-200">
                {daapProcesses.filter(p => p.status === "Aprovado").length}
              </div>
              <p className="text-sm text-green-600 dark:text-green-400">Declarações aprovadas</p>
            </CardContent>
          </Card>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Declaração de Atividades Ambientais - Acompanhe todas as declarações
                </CardDescription>
              </div>
              <Badge variant="outline" className="text-gray-700 border-gray-200">
                {daapProcesses.length} processos
              </Badge>
            </div>
          </CardHeader>
          <CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <h4 className="font-medium text-foreground">O que é o DAAP?</h4>
                <p className="text-sm text-muted-foreground">
                  A Declaração de Atividades Ambientais (DAAP) é um documento que relaciona 
                  todas as atividades potencialmente poluidoras desenvolvidas na propriedade.
                </p>
              </div>
              <div className="space-y-2">
                <h4 className="font-medium text-foreground">Documentos Necessários</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Declaração de atividades</li>
                  <li>• Relatório ambiental</li>
                  <li>• Inventário de emissões</li>
                  <li>• Plano de monitoramento</li>
                </ul>
              </div>
            </div>
          </CardContent>
              ...
              {uploadProcess && (
                <div className="p-3 bg-gray-50 rounded-md">
                  <div className="flex items-center gap-2 mb-2">
                    <FileText className="h-4 w-4 text-gray-600" />
                    <span className="font-medium text-sm">DAAP</span>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-green-50 rounded-md">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <FileText className="h-5 w-5 text-gray-600" />
                      <span className="font-medium">DAAP - {documentsProcess.id}</span>
                    </div>
                ...
                {/* Documentos Necessários (Específicos para DAAP) */}
                <div className="space-y-2">
                  <Label className="text-sm font-medium text-gray-700">Documentos Necessários para DAAP</Label>
                  <div className="grid gap-2">
                    {[
                      'Declaração de atividades ambientais',
                      'Relatório ambiental completo',
